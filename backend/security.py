...
ROLES: dict[str, dict] = {
    ...
    "manager": {
        ...
        "description": "Operations manager for queues, assignments, escalations, and team performance.",
    },
    "qa_reviewer": {
        "label": "QA Reviewer",
    ...
    "read_only_analyst": {
        ...
        "permissions": ["tickets.read", "analytics.read", "profiles.read"],
        "description": "Read-only analyst for complaint, customer, and operational reporting.",
    },
}
...
ROLE_SCOPES: dict[str, list[str]] = {
    ...
    "manager": [
        "tickets:read", "tickets:write", "tickets:assign", "tickets:escalate",
        "analytics:read", "profiles:read", "qa:review",
    ],
    ...
    "read_only_analyst": ["tickets:read", "analytics:read", "profiles:read"],
}
