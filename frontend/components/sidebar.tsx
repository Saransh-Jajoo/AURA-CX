...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { href: "/dashboard/qa-review", label: "Reviewer Desk", icon: ClipboardCheck },
  { href: "/dashboard/profiles", label: "Customer Profiles", icon: Users },
  { href: "/dashboard/hitl", label: "Worker Queue", icon: CheckSquare, badge: "LIVE", badgeVariant: "live" },
